...
Many of the changes are to fix problems found by Cppcheck and a new version of
cpplint.py.  These changes may have introduced bugs from replacing many C style
casts with the wrong C++ cast.
